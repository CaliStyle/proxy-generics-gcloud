  ...
  it('should upload a file', (done) => {
    DataStoreGenericService.uploadFile({
      ...
      .then(file => {
        ...
        assert.equal(file.url, `https://storage.googleapis.com/${Gcloud.options.bucket}/test.jpg`)
  ...
  it('should upload files', (done) => {
    DataStoreGenericService.uploadFiles([{
      ...
      .then(files => {
        ...
        assert.equal(files[0].url, `https://storage.googleapis.com/${Gcloud.options.bucket}/test.jpg`)
